[![](https://bitbag.io/wp-content/uploads/2022/02/SyliusInPostPlugin.png)](https://bitbag.io/contact-us/?utm_source=github&utm_medium=referral&utm_campaign=plugins_inpost)

# BitBag SyliusInPostPlugin
...
---
[![](https://bitbag.io/wp-content/uploads/2024/09/badges-sylius.png)](https://bitbag.io/contact-us/?utm_source=github&utm_medium=referral&utm_campaign=plugins_inpost) 
...
# Overview
---
This plugin was made on top of our ShippingExport abstraction layer. It's goal is to allow exporting InPost shipments to external web API in Sylius platform based apps. Each time new shipment for a configured InPost gateway is placed you will see a new shipment in the shipping export tab.

# Installation
---
The SyliusInPostPlugin **installation process** can be found [here](doc/installation.md).

# Usage
---
The SyliusInPostPlugin **usage** can be found [here](doc/usage.md).

# Known issues 
---
The **known issues** regarding SyliusInPostPlugin can be found [here](doc/known_issues.md) 
...
[![](https://bitbag.io/wp-content/uploads/2020/10/button_free_consulatation-1.png)](https://bitbag.io/contact-us/?utm_source=github&utm_medium=referral&utm_campaign=plugins_inpost)
...
[![](https://bitbag.io/wp-content/uploads/2020/10/button-contact.png)](https://bitbag.io/contact-us/?utm_source=github&utm_medium=referral&utm_campaign=plugins_inpost)
